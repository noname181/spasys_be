                ...
                if (isset($rate_data_general->ag_no)) {
                    ...
                    if ($ag->ag_auto_issue == 'y' && $rgd->rgd_calculate_deadline_yn == 'y') {
                        ...
                        if (!isset($cbh->cbh_no)) {
                            ...
                            $api = WarehousingController::tax_invoice_api($rgd, $user, $tid, $tax_number, null, true, $ag->ag_email, $company);
    ...
    public function create_package_delivery(Request $request)
    {
        ...
        try {
            ...
            if (isset($dataSubmit)) {
                ...
                //message
                if (isset($dataSubmit['rgd_delivery_man_hp']) && $dataSubmit['rgd_delivery_man_hp'] != "" && $dataSubmit['rgd_status3'] == "배송중"){
