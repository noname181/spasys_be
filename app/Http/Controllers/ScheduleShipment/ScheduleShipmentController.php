            ...
            $user = Auth::user();
                foreach ($request->data as $i_schedule => $schedule) {
                    $ss_no = ScheduleShipment::insertGetId([
                        ...
                        'order_date' => isset($schedule['order_date']) ? $schedule['order_dateseq'] : null,
                    ...
                    if(isset($schedule['order_products'])){
                        foreach ($schedule['order_products'] as $ss_info => $schedule_info) {
                            $ss_info_no = ScheduleShipmentInfo::insertGetId([
                                'ss_no' => $ss_no,
                                'co_no' => $user->co_no,
                                'barcode' => isset($schedule_info['barcode']) ? $schedule['barcode'] : null,
                                'brand' => isset($schedule_info['brand']) ? $schedule['brand'] : null,
                                'cancel_date' =>isset( $schedule_info['cancel_date']) ? $schedule['cancel_date'] : null,
                                'change_date' => isset($schedule_info['change_date']) ? $schedule['change_date'] : null,
                                'enable_sale' => isset($schedule_info['enable_sale']) ? $schedule['enable_sale'] : null,
                                'extra_money' => isset($schedule_info['extra_money']) ? $schedule['extra_money'] : null,
                                'is_gift' => isset($schedule_info['is_gift']) ? $schedule['is_gift'] : null,
                                'link_id' => isset($schedule_info['link_id']) ? $schedule['link_id'] : null,
                                'name' => isset($schedule_info['name']) ? $schedule['name'] : null,
                                'new_link_id' => isset($schedule_info['new_link_id']) ? $schedule['new_link_id'] : null,
                                'options' => isset($schedule_info['options']) ? $schedule['options'] : null,
                                'order_cs' => isset($schedule_info['order_cs']) ? $schedule['order_cs'] : null,
                                'prd_amount' => isset($schedule_info['prd_amount']) ? $schedule['prd_amount'] : null,
                                'prd_seq' => isset($schedule_info['prd_seq']) ? $schedule['prd_seq'] : null,
                                'prd_supply_price' => isset($schedule_info['prd_supply_price']) ? $schedule['prd_supply_price'] : null,
                                'product_id' => isset($schedule_info['product_id']) ? $schedule['product_id'] : null,
                                'qty' => isset($schedule_info['qty']) ? $schedule['qty'] : null,
                                'shop_price' => isset($schedule_info['shop_price']) ? $schedule['shop_price'] : null,
                                'supply_code' =>isset( $schedule_info['supply_code']) ? $schedule['supply_code'] : null,
                                'supply_name' => isset($schedule_info['supply_name']) ? $schedule['supply_name'] : null,
                                'supply_options' => isset($schedule_info['supply_options']) ? $schedule['supply_options'] : null,
